...
@interface CalibrationMacBook : NSWindowController
...
@property (weak) IBOutlet NSTextField *stressTestCycle;
@property (weak) IBOutlet NSTextField *lblTestCycle;
...
@property (weak) IBOutlet NSTextField *brightness2;
...
@property (weak) IBOutlet NSColorWell *inBotVacuumWarning;
@property (weak) IBOutlet NSColorWell *inTopVacuumWarning;
@property (weak) IBOutlet NSColorWell *inUSBCylinderFrontLimit;
@property (weak) IBOutlet NSColorWell *inUSBCylinderBackLimit;


@property (weak) IBOutlet NSColorWell *inTopSensor1;
@property (weak) IBOutlet NSColorWell *inTopSensor2;


@property (weak) IBOutlet NSColorWell *inBotSensor1;
@property (weak) IBOutlet NSColorWell *inBotSensor2;

@property (weak) IBOutlet NSColorWell *inFrontDoor;
@property (weak) IBOutlet NSColorWell *inDoorLock;
...
@property (weak) IBOutlet NSButton *outBotVacuun;
@property (weak) IBOutlet NSButton *outTopVacuun;
@property (weak) IBOutlet NSButton *outUSBCylinder;
@property (weak) IBOutlet NSButton *outBotBlow;
@property (weak) IBOutlet NSButton *outTopBlow;
...
@property (weak) IBOutlet NSTextField *Pix2mmRatio;
- (IBAction)clickPix2mmCal:(id)sender;
- (IBAction)clickPix2mmCalSave:(id)sender;

#pragma mark - Z1 Landing Result Zone
@property (weak) IBOutlet NSTextField *z1PID_Result;
